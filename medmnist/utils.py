...
def save2d(imgs, labels, img_folder, split, postfix, csv_path):
...
def save3d(imgs, labels, img_folder, split, postfix, csv_path):
    print(f"Saving {split} set to {img_folder}, csv_path={csv_path}...")
    return save_fn(
        imgs,
        labels,
...
def save_fn(imgs, labels, img_folder, split, postfix, csv_path, load_fn, save_fn):
